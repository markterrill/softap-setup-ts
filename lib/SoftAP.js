...
var SoftAPOptions = {};
SoftAPOptions.defaultOptions = function () {
    return {
        host: '192.168.0.1',
        keepAlive: true,
        timeout: 8000,
...
SoftAPOptions.assign = function (opts, options) {
...
var SoftAP = (function () {
    ...
    SoftAP.prototype._sendProtocolCommand = function (cmd, cb) {
    ...
    SoftAP.prototype._sendProtocolCommandTcp = function (cmd, cb) {
        var that = this;
    ...
    SoftAP.prototype._sendProtocolCommandHttp = function (cmd, cb) {
        var payload;
    ...
    SoftAP.prototype.scan = function (cb) {
        is(cb);
    ...
    SoftAP.prototype.connect = function (index, cb) {
        var cbFormated;
        var indexFormated;
        if (!cb) {
    ...
    SoftAP.prototype.deviceInfo = function (cb) {
        is(cb);
    ...
    SoftAP.prototype.publicKey = function (cb) {
        is(cb);
    ...
    SoftAP.prototype.set = function (data, cb) {
        is(cb);
    ...
    SoftAP.prototype.configure = function (opts, cb) {
        is(cb);
...
export { SoftAP };
//# sourceMappingURL=SoftAP.js.map